<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:99:"E:\wamp\bin\apache\apache2.4.9\htdocs\xiaochengxu\public/../application/admin\view\login\index.html";i:1534737182;}*/ ?>
<!DOCTYPE html>
<html>
...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen  animated fadeInDown">
        <div>
            <!-- <div class="m-b-md">
                <img src="/uploads/head.png" class='img-circle circle-border' alt="">
            </div> -->
